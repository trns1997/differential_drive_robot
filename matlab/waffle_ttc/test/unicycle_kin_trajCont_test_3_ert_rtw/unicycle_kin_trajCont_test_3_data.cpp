/*
 * unicycle_kin_trajCont_test_3_data.cpp
 *
...
P_unicycle_kin_trajCont_test__T unicycle_kin_trajCont_test_3_P = {
  /* Mask Parameter: Eighttrajectory_L
   * Referenced by: '<S1>/Constant2'
   */
  3.0,

  /* Mask Parameter: Eighttrajectory_v
