/*
 * unicycle_kin_trajCont_test_1_types.h
 *
...
#ifndef RTW_HEADER_unicycle_kin_trajCont_test_1_types_h_
#define RTW_HEADER_unicycle_kin_trajCont_test_1_types_h_
#include "rtwtypes.h"
#include "multiword_types.h"

/* Model Code Variants */
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_unicycle_kin_trajCont_test_1_geometry_msgs_Point_
#define DEFINED_TYPEDEF_FOR_SL_Bus_unicycle_kin_trajCont_test_1_geometry_msgs_Point_

typedef struct {
  real_T X;
  real_T Y;
  real_T Z;
} SL_Bus_unicycle_kin_trajCont_test_1_geometry_msgs_Point;
...
typedef struct P_unicycle_kin_trajCont_test__T_ P_unicycle_kin_trajCont_test__T;

/* Forward declaration for rtModel */
typedef struct tag_RTM_unicycle_kin_trajCont_T RT_MODEL_unicycle_kin_trajCon_T;

#endif                    /* RTW_HEADER_unicycle_kin_trajCont_test_1_types_h_ */
